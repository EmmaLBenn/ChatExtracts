...
phq4_items <- c("PHQ4_Anxiety_1", "PHQ4_Anxiety_2", "PHQ4_Depression_3", "PHQ4_Depression_4")
...
print(colSums(is.na(phq4_df)))


# PHQ-4 Depression (2 items)
...
# PHQ-4 Anxiety (2 items)
alpha_anx <- psych::alpha(phq4_df[, c("PHQ4_Anxiety_1", "PHQ4_Anxiety_2")])
cat("PHQ-4 Anxiety alpha:", round(alpha_anx$total$raw_alpha, 2), "\n")


cor(phq4_df[, c("PHQ4_Depression_3", "PHQ4_Depression_4")], 
    use = "pairwise.complete.obs")[1,2] |> round(2)

cor(phq4_df[, c("PHQ4_Anxiety_1", "PHQ4_Anxiety_2")], 
    use = "pairwise.complete.obs")[1,2] |> round(2)
```


# 10. MINT Omega Values

```{r}
omega_mint <- psych::omega(mint_items, nfactors = 11, plot = FALSE)
cat("Full scale omega_h:", round(omega_mint$omega_h, 2), "\n")
cat("Full scale omega_t:", round(omega_mint$omega.tot, 2), "\n")
```
